...
for _, r in df.iterrows():
    records.append({
        ...
        'url': str(r.get('Product_URL','')) if pd.notna(r.get('Product_URL')) and r.get('Product_URL') else '',
    })
...
header{background:linear-gradient(135deg,#1a2035,#2d3a5e);border-bottom:2px solid #3b82f6}
section{background:#ffffff;border-color:#e8ecf0;box-shadow:0 1px 4px rgba(0,0,0,.06)}
.sticky.top-0{background:rgba(255,255,255,.97);border-bottom-color:#e2e8f0}
.shadow-sm{box-shadow:0 1px 4px rgba(0,0,0,.07)}
.tbl-wrap th{background:#1F4E79;color:#fff}
.tbl-wrap th:hover{background:#2E75B6}
.tbl-wrap td{border-bottom-color:#f0f0f0;color:#1e293b}
.tbl-wrap tr:nth-child(even) td{background:#f8fafc}
.tbl-wrap tr:nth-child(odd) td{background:#ffffff}
.tbl-wrap tr:hover td{background:#eff6ff}
.tbl-wrap a{color:#2563eb}
.ms-btn{background:#fff;color:#374151;border-color:#d1d5db}
.ms-btn:hover{border-color:#2563eb;background:#eff6ff}
.ms-menu{background:#fff;border-color:#e2e8f0;box-shadow:0 8px 25px rgba(0,0,0,.12)}
.ms-menu label:hover{background:#f1f5f9}
.ms-menu label{color:#374151}
.ms-menu .ms-actions button{color:#2563eb}
.ms-menu .ms-actions button.ms-none{color:#dc2626}
.pt-sel,.sec-search{background:#fff;color:#374151;border-color:#d1d5db}
nav a.rounded-full{color:#475569;border-color:#e2e8f0}
nav a.rounded-full:hover{background:#eff6ff;color:#1e40af}
nav a.bg-navy-800.rounded-full{color:#fff}
.dir-btn.active,.s5agg-btn.active,.agg-btn.active{background:#2563eb;color:#fff}
.dir-btn:not(.active),.s5agg-btn:not(.active),.agg-btn:not(.active){background:#f1f5f9;color:#64748b;border-color:#e2e8f0}
.level-cat td{background:#dbeafe!important;color:#1e3a8a!important;border-left-color:#2563eb!important}
.level-comp td{background:#eff6ff!important;color:#1d4ed8!important;border-left-color:#60a5fa!important}
.level-hc td{background:#fef9c3!important;color:#713f12!important;border-left-color:#facc15!important}
.level-ton td{background:#fff!important;color:#475569!important;border-left-color:#d1d5db!important}
.up-cell{color:#dc2626;font-weight:700}
.dn-cell{color:#16a34a;font-weight:700}
...
.promo-badge{background:#fef3c7;color:#92400e}
