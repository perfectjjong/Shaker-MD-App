...
for _, r in df.iterrows():
    records.append({
        ...
        'url': f'https://www.almanea.sa/en/product/{r.get("URL_Key","")}' if pd.notna(r.get('URL_Key')) and r.get('URL_Key') else '',
    })
...
for sku, dates_set in sku_date_map.items():
    ...
    if last_d == latest_d:
        ...
        disc_records.append({
            ...
            'url': f'https://www.almanea.sa/en/product/{row.get("URL_Key","")}' if pd.notna(row.get('URL_Key')) and row.get('URL_Key') else '',
        })
