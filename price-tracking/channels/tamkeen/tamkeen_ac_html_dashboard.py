...
.tbl-wrap th{background:#0d9488;color:#fff;padding:7px 10px;text-align:left;position:sticky;top:0;z-index:2;white-space:nowrap;cursor:pointer;user-select:none;font-weight:600;font-size:11px}
.tbl-wrap th:hover{background:#14b8a6}
...
<header class="bg-gradient-to-r from-teal-800 to-teal-600 text-white shadow-lg">
  <div class="max-w-[1600px] mx-auto px-4 sm:px-6 py-3 sm:py-4 flex flex-wrap items-center justify-between gap-2 sm:gap-4">
    <div><h1 class="text-base sm:text-xl font-bold tracking-wide">Tamkeen AC Price Tracker</h1>
      <p class="text-xs text-teal-200 mt-1">Saudi Arabia &middot; Air Conditioners &middot; Daily Price Monitoring</p></div>
    <div class="text-right text-xs text-teal-100 space-y-0.5">
...
<div class="sticky top-0 z-40 bg-white/95 backdrop-blur border-b border-gray-200 shadow-sm no-print">
  <div class="max-w-[1600px] mx-auto px-3 sm:px-6 py-2 sm:py-2.5 flex flex-wrap items-center gap-2">
    <span class="text-[10px] font-bold text-teal-700 uppercase tracking-wider">Global</span>
    <div id="gf_date"></div>
...
<nav class="max-w-[1600px] mx-auto px-3 sm:px-6 pt-2 sm:pt-3 no-print">
  <div class="flex flex-wrap gap-1.5 text-[11px]">
    <a href="#sec-kpi" class="px-3 py-1 bg-teal-700 text-white rounded-full font-medium">KPIs</a>
    <a href="#sec-alert" class="px-3 py-1 bg-white text-teal-800 rounded-full border border-gray-200 hover:bg-teal-50">Price Alerts</a>
    <a href="#sec-new" class="px-3 py-1 bg-white text-teal-800 rounded-full border border-gray-200 hover:bg-teal-50">New/Disc</a>
    <a href="#sec-catKPI" class="px-3 py-1 bg-white text-teal-800 rounded-full border border-gray-200 hover:bg-teal-50">Category KPI</a>
    <a href="#sec-brand" class="px-3 py-1 bg-white text-teal-800 rounded-full border border-gray-200 hover:bg-teal-50">Brand Compare</a>
    <a href="#sec-trend" class="px-3 py-1 bg-white text-teal-800 rounded-full border border-gray-200 hover:bg-teal-50">Price Trend</a>
    <a href="#sec-sku" class="px-3 py-1 bg-white text-teal-800 rounded-full border border-gray-200 hover:bg-teal-50">Full SKU</a>
    <a href="#sec-stock" class="px-3 py-1 bg-white text-teal-800 rounded-full border border-gray-200 hover:bg-teal-50">Stock</a>
    <a href="#sec-delivery" class="px-3 py-1 bg-white text-teal-800 rounded-full border border-gray-200 hover:bg-teal-50">Delivery</a>
  </div>
</nav>
...
<section id="sec-kpi" class="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
  <h2 class="text-sm font-bold text-teal-800 border-b-2 border-teal-700 pb-2 mb-3">Key Performance Indicators</h2>
...
<section id="sec-alert" class="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
  <h2 class="text-sm font-bold text-teal-800 border-b-2 border-teal-700 pb-2 mb-3">Price Change Alert <span class="text-xs font-normal text-gray-400">(vs compare date)</span></h2>
...
<section id="sec-new" class="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
  <h2 class="text-sm font-bold text-teal-800 border-b-2 border-teal-700 pb-2 mb-3">New & Discontinued SKUs</h2>
...
<section id="sec-catKPI" class="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
  <h2 class="text-sm font-bold text-teal-800 border-b-2 border-teal-700 pb-2 mb-3">Category KPI Table</h2>
...
<section id="sec-brand" class="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
  <h2 class="text-sm font-bold text-teal-800 border-b-2 border-teal-700 pb-2 mb-3">Brand Price Comparison</h2>
  <div class="flex flex-wrap items-center gap-2 mb-3 pb-2 border-b border-gray-100">
    <span class="text-[10px] font-bold text-gray-400 uppercase">Filters</span>
    ...
    <div class="flex rounded-lg overflow-hidden border border-gray-200">
      <button type="button" class="s5agg-btn active px-3 py-1 text-[10px] font-medium bg-teal-700 text-white" data-agg="avg">Avg</button>
...
<section id="sec-trend" class="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
  <h2 class="text-sm font-bold text-teal-800 border-b-2 border-teal-700 pb-2 mb-3">Price Trend (Time Series)</h2>
  <div class="flex flex-wrap items-center gap-2 mb-3 pb-2 border-b border-gray-100">
    <span class="text-[10px] font-bold text-gray-400 uppercase">Filters</span>
    ...
    <div class="flex rounded-lg overflow-hidden border border-gray-200">
      <button type="button" class="agg-btn active px-3 py-1 text-[10px] font-medium bg-teal-700 text-white" data-agg="avg">Avg</button>
...
<section id="sec-sku" class="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
  <h2 class="text-sm font-bold text-teal-800 border-b-2 border-teal-700 pb-2 mb-3">Full SKU Table <span id="skuDateLabel" class="text-xs font-normal text-gray-400"></span></h2>
  <div class="flex flex-wrap items-center gap-2 mb-3 pb-2 border-b border-gray-100">
    <span class="text-[10px] font-bold text-gray-400 uppercase">Filters</span>
...
<section id="sec-stock" class="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
  <h2 class="text-sm font-bold text-teal-800 border-b-2 border-teal-700 pb-2 mb-3">Stock Dashboard</h2>
...
<section id="sec-delivery" class="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
  <h2 class="text-sm font-bold text-teal-800 border-b-2 border-teal-700 pb-2 mb-3">Delivery Analysis</h2>
  <div class="flex flex-wrap items-center gap-2 mb-3 pb-2 border-b border-gray-100">
    <span class="text-[10px] font-bold text-gray-400 uppercase">Filters</span>
...
class MS {
  ...
  _upd(){const avail=this._availCount();this.btnEl.innerHTML=`${this.label} <b class="text-teal-700">${this.sel.size}/${avail}</b> <span class="text-gray-400 text-[9px]">&#9662;</span>`;}
...
function renderNewDisc(lat,prev){
  ...
  const card=(r,clr)=>`<div class="border border-${clr}-200 bg-${clr}-50 rounded-lg p-2.5 flex justify-between items-center"><div><span class="text-xs font-bold" style="color:${colorOf(r.b)}">${r.b}</span> <span class="text-[10px] text-gray-400">${r.m||''}</span><div class="text-[11px] mt-0.5 truncate max-w-[280px]">${r.url?`<a href="${r.url}" target="_blank" class="text-blue-600 hover:underline">${r.n}</a>`:r.n}</div><div class="text-[10px] text-gray-400">${r.c||''} &middot; ${r.t?r.t.toFixed(1)+'T':''} &middot; Stock: ${r.stk!=null?r.stk:'N/A'} &middot; ${r.exp?'Express':'No Express'}</div></div><div class="text-sm font-bold text-gray-700">${fmtSAR(r.fp)} SAR</div></div>`;
